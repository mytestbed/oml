...
EXTRA_BUILD_OBJ_DIRS = $(EXTRA_OBJ_DIRS:%=$(BUILD_OBJ_DIR)/%)
...
#$(LIBRARY): $(BUILD_LIB_DIR)/$(LIB_FILE)
$(LIBRARY): $(SRCS) $(EXT) $(BUILD_LIB_DIR)/$(LIB_FILE) $(BUILD_INC_DIR) $(PUBLIC_INCS)
	@
    
$(BUILD_LIB_DIR)/$(LIB_FILE): $(SRCS) $(BUILD_OBJ_DIR) $(EXTRA_BUILD_OBJ_DIRS) $(BUILD_LIB_DIR) $(OBJS)
	$(CC) -fPIC -shared $(LDFLAGS) $(LIBS) -o $@ $(OBJS)
endif
